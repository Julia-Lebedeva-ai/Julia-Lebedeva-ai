...
### 4. 📞 Анализ записи CX интервью с выявлением tone of voice, удобств и проблем, отмеченных клиентами
**📋 Описание:** Получение записей клиентских интервью через gmail (может быть также через диск), перевод файла с записью интервью из речи в текст, анализ через LLM и выявляение настроения клиента, проблем и положительных сторон, которые отметил клиент, запись результатов анализа в Google sheet.
...
https://docs.google.com/spreadsheets/d/1kZq1WglcBdvKdl2OVAdlLtq9zFMepgvJgaOTr6d051U/edit?usp=sharing
